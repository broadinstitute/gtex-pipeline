...
Releases V6/V6p and V7 were based on the [GENCODE v19](https://www.gencodegenes.org/human/release_19.html) annotation; release V8 will be based on [GENCODE v26](https://www.gencodegenes.org/releases/26.html).
